...
namespace QuanLySach.Controllers
{
    public class SachController : ApiController
    {
        Sach[] sachs = new Sach[]
        {
            ...
            new Sach { Id = 2, Title = "Pro ASP.NET MVC5", AuthorName = "Adam Freeman", Price = 3.75M, Content = "The ASP.NET MVC 5 Framwork is the latest evolution of Microsoft's ASP.NET web platform"},
        };
